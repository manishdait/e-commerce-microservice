...
public class GlobalExceptionHandler {
  ...
  public ResponseEntity<ErrorResponse<String>> handle(EntityNotFoundException e, HttpServletRequest request) {
  ...
  public ResponseEntity<ErrorResponse<String>> handle(ProductPurchaseException e, HttpServletRequest request) {
